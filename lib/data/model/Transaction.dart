...
class Transaction {
  ...
  Transaction(this.account, this.category, this.amount, this.date,
      this.description);
  ...
  Transaction.fromMap(Map<String, dynamic> map) {
    ...
    //merge table query
    category = map[CategoryTable().tableName] != null ? Category.fromMap(
        map[CategoryTable().tableName]) : null;
  }
