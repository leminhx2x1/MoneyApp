...
class _TransactionFragmentState extends State<TransactionFragment> {
  ...
  void initState() {
    ...
    super.initState();
    blocAccount = context.read<AccountBloc>();
    blocTransaction = context.read<TransactionBloc>();
  }

  List<DropdownMenuItem<String>> _getDropDownMenuItems(snapshotData) {
    var listItem = (snapshotData as List<String?>).whereType<String>().toList();
